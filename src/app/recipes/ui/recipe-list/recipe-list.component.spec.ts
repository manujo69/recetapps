...
describe('RecipeListComponent', () => {
  ...
  describe('empty state', () => {
    it('should show the salad image when recipes list is empty', fakeAsync(() => {
      mockRecipeRepository.getAll.and.returnValue(of([]));
      const fixture = TestBed.createComponent(RecipeListComponent);
      fixture.detectChanges();
      tick();
      ...
      expect(fixture.nativeElement.querySelector('img[src="salad-010.png"]')).toBeTruthy();
    }));

    it('should not show the salad image when recipes exist', fakeAsync(() => {
      mockRecipeRepository.getAll.and.returnValue(of(MOCK_RECIPES));
      const fixture = TestBed.createComponent(RecipeListComponent);
      fixture.detectChanges();
      tick();
      ...
      expect(fixture.nativeElement.querySelector('img[src="salad-010.png"]')).toBeNull();
    }));

    it('should show an inline add button (not fixed) when list is empty', fakeAsync(() => {
      mockRecipeRepository.getAll.and.returnValue(of([]));
      const fixture = TestBed.createComponent(RecipeListComponent);
      fixture.detectChanges();
      tick();
      ...
      const addLink = fixture.nativeElement.querySelector('a.mt-6');
      expect(addLink).toBeTruthy();
      expect(fixture.nativeElement.querySelector('a.fixed')).toBeNull();
    }));

    it('should show a fixed FAB and no inline add button when recipes exist', fakeAsync(() => {
      mockRecipeRepository.getAll.and.returnValue(of(MOCK_RECIPES));
      const fixture = TestBed.createComponent(RecipeListComponent);
      fixture.detectChanges();
      tick();
      ...
      expect(fixture.nativeElement.querySelector('a.fixed')).toBeTruthy();
      expect(fixture.nativeElement.querySelector('a.mt-6')).toBeNull();
    }));
  });
